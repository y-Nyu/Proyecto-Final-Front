    ...
    <section className="hero align-items-stretch">
      ...
      <div className="my-4">
        <h5 className="custom-h5">
          ...
          en el mercado, obteniendo el prestigio y el respeto que hoy nos
          precede..."
        </h5>
        <img src={imageFlyer} className="img-fluid mx-auto mt-4" style={{ width: '70%', height: 'auto' }} alt="img" />
      </div>

      <div className="experiencia seccion-clara">
        <div className="container text-center">
          <div className="row">
            {/* atencion personalizada */}
            <div className="columna col-12 col-md-4">
            <i className="bi bi-people"></i>
              <p className="experiencia-titulo">Atención personalizada</p>
            ...
            <i className="bi bi-box"></i>
              <p className="experiencia-titulo">Variedad de productos</p>
            ...
            <p className="experiencia-titulo">Los mejores precios siempre</p>
      ...
      <div className="my-4 marcas-text">
        <i className="bi bi-stars"></i> Trabajamos con las mejores marcas del
        mercado
